...
###  Problema 1: Evaluación de Polinomio (x+1)^n
Este programa solicita al usuario un número entero no negativo `n` y un valor `x`. Su objetivo es calcular y mostrar los coeficientes del polinomio `(x+1)^n`, evaluar paso a paso la función para el valor de `x` dado, y finalmente medir el tiempo de ejecución del proceso. Los resultados y el tiempo de ejecución se guardan en un archivo de texto
* **Lenguajes utilizados:** ![Dev C++](https://img.shields.io/badge/C%2B%2B-blue) y ![Java](https://img.shields.io/badge/Java-white)
...
### 📜 Requisitos para ejecutar archivos de C y C++ 
   ...
   - Compilar y correr usando la tecla `F11`
---
...
- Instalar JDK 21
 ...
 ```
- Usar el entorno [![Visual Studio Code](https://img.shields.io/badge/Visual_Studio_Code-blue)](https://code.visualstudio.com/) junto a la extension: **Extension Pack for Java**
- Abrir `Problema_1.java` o `Problema_2.java`
- Darle al boton `▶️ Run Java`
